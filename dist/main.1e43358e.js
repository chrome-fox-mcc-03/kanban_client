...
exports.default = _default;
        var $0a0250 = exports.default || module.exports;
      
      if (typeof $0a0250 === 'function') {
        $0a0250 = $0a0250.options;
      }
    
        /* template */
        Object.assign($0a0250, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("sui-menu", { attrs: { secondary: "", id: "navbar" } }, [
    _c(
      "div",
      ...
      [
        _vm.currentPage === "home"
          ...
          : _vm._e(),
        _vm._v(" "),
        _vm.currentPage === "group"
          ? _c(
              "sui-button",
              {
                staticStyle: { background: "none", width: "10vw" },
                attrs: { animated: "vertical" },
                on: {
                  click: function($event) {
                    return _vm.changePage("create-group")
                  }
                }
              },
              [
        ...
        _vm.currentPage === "register"
          ? _c(
              ...
              [
                _c(
                  "sui-button-content",
                  { staticStyle: { color: "blue" }, attrs: { hidden: "" } },
                  [_vm._v("Login")]
                ),
                _vm._v(" "),
                _c(
          ...
          ? _c(
              ...
              [
                _c(
                  "sui-button-content",
                  { staticStyle: { color: "orange" }, attrs: { hidden: "" } },
                  [_vm._v("Register")]
                ),
                _vm._v(" "),
                _c(
                  ...
                  [
                    _c("sui-icon", {
                      staticStyle: { background: "none" },
                      attrs: { name: "external alternate", color: "orange" }
                    })
                  ],
                  1
                )
          ...
          : _vm.currentPage === "create" || _vm.currentPage === "edit"
          ? _c(
              "sui-button",
              {
                staticStyle: { background: "none" },
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$0a0250', $0a0250);
          } else {
            api.reload('$0a0250', $0a0250);
          }
        }
...
exports.default = _default;
        var $dc19ea = exports.default || module.exports;
      
      if (typeof $dc19ea === 'function') {
        $dc19ea = $dc19ea.options;
      }
    
        /* template */
        Object.assign($dc19ea, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      ...
      _c(
        ...
        [
          _c("sui-loader", { attrs: { indeterminate: "" } }, [
            _vm._v("Please wait...")
          ])
        ],
        1
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$dc19ea', $dc19ea);
          } else {
            api.reload('$dc19ea', $dc19ea);
          }
        }
  ...
  methods: {
    ...
    gLogin: function gLogin() {
      ...
      this.$gAuth.signIn().then(function (authCode) {
        ...
        _this2.changePage('group');

        _this2.notification(data.message);
      }).catch(function (err) {
        _this2.visible = true;
        _this2.title = 'ERROR!';
...
exports.default = _default;
        var $30b05f = exports.default || module.exports;
      
      if (typeof $30b05f === 'function') {
        $30b05f = $30b05f.options;
      }
    
        /* template */
        Object.assign($30b05f, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$30b05f', $30b05f);
          } else {
            api.reload('$30b05f', $30b05f);
          }
        }
...
/******/
{
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    (function (global) {
      ...
      var core_js_modules_es6_regexp_replace__WEBPACK_IMPORTED_MODULE_0___default =
      /*#__PURE__*/
...
},{"sortablejs":"node_modules/sortablejs/modular/sortable.esm.js"}],"src/components/Card/Option.vue":[function(require,module,exports) {
"use strict";
  ...
  methods: {
    ...
    fetchEdit: function fetchEdit() {
      ...
      axios({
        ...
        _this.$emit('payloadEdit', data.data);

        _this.changePage('edit');
      }).catch(function (err) {
        _this.notification(err.response.data.message, _this.payload.idCategory);
      }).finally(function (_) {
        _this.active = false;
      });
    },
    destroy: function destroy() {
      ...
      axios({
        ...
        _this2.notification(data.message, _this2.payload.idCategory);
      }).catch(function (err) {
        _this2.notification(err.response.data.message, _this2.payload.idCategory);
      }).finally(function (_) {
        _this2.active = false;
      });
    },
    ...
    notification: function notification(message, catId) {
      this.$emit('notification', {
        action: true,
        title: 'Success',
        message: message,
...
exports.default = _default;
        var $86130d = exports.default || module.exports;
      
      if (typeof $86130d === 'function') {
        $86130d = $86130d.options;
      }
    
        /* template */
        Object.assign($86130d, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
        ...
        [
          _c(
            "sui-button",
            {
              staticStyle: { background: "none" },
              attrs: { animated: "" },
              on: { click: _vm.fetchEdit }
            },
            [
              _c(
                "sui-button-content",
                { attrs: { visible: "" } },
                [_c("sui-icon", { attrs: { color: "blue", name: "edit" } })],
                1
              ),
              _vm._v(" "),
              _c(
                "sui-button-content",
                {
                  staticStyle: { color: "#2185d0!important" },
                  attrs: { hidden: "" }
                },
                [_vm._v("Edit")]
              )
          ...
          _c(
            ...
            [
              _c(
                ...
                [
                  _c("sui-icon", {
                    attrs: { color: "red", name: "trash alternate" }
                  })
                ],
                1
              ),
        ...
        [
          ...
          _c(
            ...
            [
              ...
              _c(
                "sui-button",
                { attrs: { negative: "" }, on: { click: _vm.destroy } },
                [_vm._v("\n        Delete\n      ")]
              )
            ],
            1
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$86130d', $86130d);
          } else {
            api.reload('$86130d', $86130d);
          }
        }
...
var _default = {
  ...
  methods: {
    ...
    notification: function notification(payload) {
      this.$emit('notification', payload); // this.fetchTask()
    }
  },
  created: function created() {
  ...
  watch: {
    tasks: function tasks() {
      ...
      var taskUpdate = this.tasks.filter(function (el) {
        return el.CategoryId !== _this2.categoryId;
      });
      taskUpdate.forEach(function (el) {
        axios({
          method: 'put',
          url: "https://ancient-dawn-78678.herokuapp.com/task/".concat(el.id),
          headers: {
            token: localStorage.getItem('token'),
...
exports.default = _default;
        var $41cc87 = exports.default || module.exports;
      
      if (typeof $41cc87 === 'function') {
        $41cc87 = $41cc87.options;
      }
    
        /* template */
        Object.assign($41cc87, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      _c(
        "draggable",
        {
          attrs: { group: "job", emptyInsertThreshold: 200 },
          on: {
        ...
        _vm._l(_vm.fetch, function(ref, i) {
          var id = ref.id
          var title = ref.title
                      ...
                      _c("Option", {
                        attrs: {
                          payload: {
                            id: id,
                            idGroup: _vm.idGroup,
                            idCategory: _vm.idCategory
                          }
                        },
                        on: {
                          notification: _vm.notification,
                          payloadEdit: _vm.edit,
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$41cc87', $41cc87);
          } else {
            api.reload('$41cc87', $41cc87);
          }
        }
...
},{"vuedraggable":"node_modules/vuedraggable/dist/vuedraggable.common.js","./Option":"src/components/Card/Option.vue","_css_loader":"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/Card/Template.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $b53e61 = exports.default || module.exports;
      
      if (typeof $b53e61 === 'function') {
        $b53e61 = $b53e61.options;
      }
    
        /* template */
        Object.assign($b53e61, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
      ...
      _c(
        ...
        [
          _c(
            ...
            { attrs: { name: "fade" } },
            [
              _vm.visible && _vm.categoryId === _vm.catId
                ? _c("sui-message", {
                    staticStyle: { "": "color:color" },
                    attrs: {
                      header: _vm.title,
          ...
          _vm._v(" "),
          _c("card", {
            attrs: { categoryId: _vm.categoryId, groupId: _vm.groupId },
            on: {
              notification: _vm.notification,
              payloadEdit: _vm.edit,
              changePage: _vm.changePage
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$b53e61', $b53e61);
          } else {
            api.reload('$b53e61', $b53e61);
          }
        }
...
},{"./Card":"src/components/Card/Card.vue","_css_loader":"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/Home/Home.vue":[function(require,module,exports) {
"use strict";
...
var _Template = _interopRequireDefault(require("../Card/Template"));
...
exports.default = _default;
        var $d46cb3 = exports.default || module.exports;
      
      if (typeof $d46cb3 === 'function') {
        $d46cb3 = $d46cb3.options;
      }
    
        /* template */
        Object.assign($d46cb3, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$d46cb3', $d46cb3);
          } else {
            api.reload('$d46cb3', $d46cb3);
          }
        }
...
},{"../Card/Template":"src/components/Card/Template.vue","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/Form/Create.vue":[function(require,module,exports) {
"use strict";
  ...
  methods: {
    ...
    createTask: function createTask() {
      ...
      axios({
        ...
        _this.notification(data.message, 1);
...
exports.default = _default;
        var $bdb3a0 = exports.default || module.exports;
      
      if (typeof $bdb3a0 === 'function') {
        $bdb3a0 = $bdb3a0.options;
      }
    
        /* template */
        Object.assign($bdb3a0, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
            ...
            _c(
              ...
              [
                ...
                _c("sui-form-field", [
                  ...
                  _vm._v(" "),
                  _c("div", { staticClass: "ui left icon input" }, [
                    _c("i", { staticClass: "clipboard icon" }),
                    _vm._v(" "),
                    _c("input", {
                      directives: [
                        {
                      ...
                      domProps: { value: _vm.titleTask },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.titleTask = $event.target.value
                        }
                      }
                    })
                  ])
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$bdb3a0', $bdb3a0);
          } else {
            api.reload('$bdb3a0', $bdb3a0);
          }
        }
...
},{"_css_loader":"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/Group/Group.vue":[function(require,module,exports) {
"use strict";
  ...
  methods: {
    listGroup: function listGroup() {
      ...
      axios({
        ...
        _this.visible = true;
        _this.title = 'ERROR!';
        _this.message = 'ERROR load list group';
      }).finally(function (_) {
        _this.active = false;
      });
    },
    ...
    destroy: function destroy() {
      ...
      axios({
        method: 'delete',
        url: "https://ancient-dawn-78678.herokuapp.com/group/".concat(this.groupId),
        headers: {
          token: localStorage.getItem('token'),
...
exports.default = _default;
        var $2e523f = exports.default || module.exports;
      
      if (typeof $2e523f === 'function') {
        $2e523f = $2e523f.options;
      }
    
        /* template */
        Object.assign($2e523f, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    [
      ...
      _c(
        ...
        [
          _c(
            ...
            [
              _c(
                "sui-table-row",
                [
                  _c("sui-table-header-cell", [_vm._v("No")]),
                  _vm._v(" "),
                  _c("sui-table-header-cell", [_vm._v("Group Name")]),
                  _vm._v(" "),
                  _c("sui-table-header-cell", [_vm._v("Join")]),
                  _vm._v(" "),
                  _c("sui-table-header-cell", [_vm._v("Invite")]),
                  _vm._v(" "),
                  _c("sui-table-header-cell", [_vm._v("Delete")])
                ],
                1
              )
            ],
          ...
          _vm._v(" "),
          _vm._l(_vm.groups, function(ref, i) {
            var Group = ref.Group
            return _c(
              "sui-table-body",
              { key: i },
              [
                _c(
                  "sui-table-row",
                  [
                    _c("sui-table-cell", [_vm._v(_vm._s(i + 1))]),
                    _vm._v(" "),
                    _c("sui-table-cell", [_vm._v(_vm._s(Group.group_name))]),
                    _vm._v(" "),
                    _c(
                      "sui-table-cell",
                      [
                        _c("sui-button", {
                          ...
                          attrs: { color: "green", content: "Join" },
                          on: {
                            click: function($event) {
                              return _vm.join(Group.id)
                            }
                          }
                        })
                      ],
                    ...
                    _c(
                      ...
                      [
                        _c("sui-button", {
                          staticStyle: { "font-size": "smaller" },
                          attrs: { color: "blue", content: "Invite" },
                          on: {
                            click: function($event) {
                              return _vm.invite(Group.id)
                            }
                          }
                        })
                      ],
                    ...
                    _c(
                      ...
                      [
                        _c("sui-button", {
                          staticStyle: { "font-size": "smaller" },
                          attrs: { color: "red", content: "Delete" },
                          nativeOn: {
                            click: function($event) {
                              return _vm.toggle(Group.id)
                            }
                          }
                        })
                      ],
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "content", attrs: { id: "list-group" } }, [
      _c("h1", { staticClass: "ui black header" }, [
        _vm._v("\n      List Group\n    ")
      ])
    ])
  }
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$2e523f', $2e523f);
          } else {
            api.reload('$2e523f', $2e523f);
          }
        }
...
},{"_css_loader":"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/Form/CreateGroup.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $fe50cd = exports.default || module.exports;
      
      if (typeof $fe50cd === 'function') {
        $fe50cd = $fe50cd.options;
      }
    
        /* template */
        Object.assign($fe50cd, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
            ...
            _c(
              ...
              [
                ...
                _c("sui-form-field", [
                  ...
                  _vm._v(" "),
                  _c("div", { staticClass: "ui left icon input" }, [
                    _c("i", { staticClass: "building outline icon" }),
                    _vm._v(" "),
                    _c("input", {
                      directives: [
                        {
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$fe50cd', $fe50cd);
          } else {
            api.reload('$fe50cd', $fe50cd);
          }
        }
...
},{"_css_loader":"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/Form/Invite.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    invite: function invite() {
      ...
      axios({
        method: 'post',
        url: "https://ancient-dawn-78678.herokuapp.com/group/invite/".concat(this.id),
        data: {
          email: this.email
        },
        headers: {
...
exports.default = _default;
        var $6955f4 = exports.default || module.exports;
      
      if (typeof $6955f4 === 'function') {
        $6955f4 = $6955f4.options;
      }
    
        /* template */
        Object.assign($6955f4, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$6955f4', $6955f4);
          } else {
            api.reload('$6955f4', $6955f4);
          }
        }
...
},{"_css_loader":"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/Form/Edit.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    ...
    updateTask: function updateTask() {
      ...
      var id = this.payloadEdit.id;
      this.active = true;
      axios({
        method: 'put',
        url: "https://ancient-dawn-78678.herokuapp.com/task/".concat(id),
        headers: {
          token: localStorage.getItem('token'),
          groupid: this.idGroup
        },
        ...
        _this.notification(data.message, data.catId);
...
exports.default = _default;
        var $f72699 = exports.default || module.exports;
      
      if (typeof $f72699 === 'function') {
        $f72699 = $f72699.options;
      }
    
        /* template */
        Object.assign($f72699, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$f72699', $f72699);
          } else {
            api.reload('$f72699', $f72699);
          }
        }
...
var _CreateGroup = _interopRequireDefault(require("./components/Form/CreateGroup"));

var _Invite = _interopRequireDefault(require("./components/Form/Invite"));

var _Edit = _interopRequireDefault(require("./components/Form/Edit"));
...
exports.default = _default;
        var $28d448 = exports.default || module.exports;
      
      if (typeof $28d448 === 'function') {
        $28d448 = $28d448.options;
      }
    
        /* template */
        Object.assign($28d448, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [
    _c(
      ...
      [
        _c("navbar", {
          ...
          on: { changePage: _vm.changePage, clearMsg: _vm.clearMsg }
        })
      ],
      1
    ),
    ...
    _c(
      ...
      [
        _vm.currentPage === "home"
          ? _c("home", {
              attrs: { groupId: _vm.idGroup, msg: _vm.msg },
              on: {
                clearMsg: _vm.clearMsg,
                changePage: _vm.changePage,
                payloadEdit: _vm.edit
          ...
          : _vm.currentPage === "register"
          ? _c("register", {
              on: { changePage: _vm.changePage, notification: _vm.notification }
            })
          : _vm.currentPage === "login"
          ? _c("login", {
              attrs: { msg: _vm.msg },
          ...
          ? _c("create", {
              attrs: { groupId: _vm.idGroup },
              on: { changePage: _vm.changePage, notification: _vm.notification }
            })
          : _vm.currentPage === "invite"
          ? _c("invite", {
              attrs: { groupId: _vm.idGroup },
              on: { changePage: _vm.changePage, notification: _vm.notification }
            })
          ...
          ? _c("edit", {
              attrs: { groupId: _vm.idGroup, payloadEdit: _vm.payloadEdit },
              on: { changePage: _vm.changePage, notification: _vm.notification }
            })
          : _c("createg", {
              on: { changePage: _vm.changePage, notification: _vm.notification }
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$28d448', $28d448);
          } else {
            api.reload('$28d448', $28d448);
          }
        }
...
},{"./components/Navbar/Navbar":"src/components/Navbar/Navbar.vue","./components/Form/Register":"src/components/Form/Register.vue","./components/Form/Login":"src/components/Form/Login.vue","./components/Home/Home":"src/components/Home/Home.vue","./components/Form/Create":"src/components/Form/Create.vue","./components/Group/Group":"src/components/Group/Group.vue","./components/Form/CreateGroup":"src/components/Form/CreateGroup.vue","./components/Form/Invite":"src/components/Form/Invite.vue","./components/Form/Edit":"src/components/Form/Edit.vue","_css_loader":"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"node_modules/semantic-ui-vue/dist/commonjs/semantic-ui-vue.js":[function(require,module,exports) {
...
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","./App.vue":"src/App.vue","semantic-ui-vue":"node_modules/semantic-ui-vue/dist/commonjs/semantic-ui-vue.js","vue-google-oauth2":"node_modules/vue-google-oauth2/index.js","semantic-ui-css/semantic.min.css":"node_modules/semantic-ui-css/semantic.min.css","../assets/style/style.css":"assets/style/style.css"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
