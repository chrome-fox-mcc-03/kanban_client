...
var _default = {
  ...
  methods: {
    ...
    deleteTask: function deleteTask(id) {
      ...
      (0, _axios.default)({
        method: "DELETE",
        url: "https://lit-peak-87737.herokuapp.com/tasks/".concat(id),
        headers: {
          token: localStorage.getItem("token")
        }
      }).then(function (_ref3) {
    ...
    nextTask: function nextTask(id) {
      ...
      (0, _axios.default)({
        method: "POST",
        url: "https://lit-peak-87737.herokuapp.com/tasks/".concat(id, "/next"),
        headers: {
          token: localStorage.getItem("token")
        }
      }).then(function (_ref4) {
    ...
    backTask: function backTask(id) {
      ...
      (0, _axios.default)({
        method: "POST",
        url: "https://lit-peak-87737.herokuapp.com/tasks/".concat(id, "/back"),
        headers: {
          token: localStorage.getItem("token")
        }
      }).then(function (_ref5) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "43893" + '/');
