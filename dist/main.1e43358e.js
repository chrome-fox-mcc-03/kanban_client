  ...
  methods: {
    fetchTask: function fetchTask() {
      ...
      axios({
        ...
        console.log(_this.tasks, 'fetch task');
      }).catch(function (err) {
...
exports.default = _default;
  ...
  return _c(
    "div",
    { staticClass: "card" },
    _vm._l(_vm.tasks, function(ref, i) {
      var id = ref.id
      var title = ref.title
...
},{"_css_loader":"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/Card/Template.vue":[function(require,module,exports) {
"use strict";
  ...
  return _c(
    ...
    [
      _vm._l(_vm.categories, function(ref) {
        ...
        return _c("temp", {
          key: id,
          attrs: { category: category, categoryId: id, groupId: _vm.idGroup }
        })
      }),
      _vm._v(" "),
      _c(
...
var _default = {
  ...
  methods: {
    invite: function invite() {
      ...
      axios({
        method: 'post',
        url: "http://localhost:3000/group/invite/".concat(this.id),
        data: {
          email: this.email
        },
        headers: {
...
exports.default = _default;
  ...
  return _c("div", [
    ...
    _c(
      ...
      [
        _vm.currentPage === "home"
          ? _c("home", { attrs: { groupId: _vm.idGroup } })
          : _vm.currentPage === "register"
          ? _c("register", {
              on: { changePage: _vm.changePage, sendMessage: _vm.sendMessage }
            })
          : _vm.currentPage === "login"
          ? _c("login", {
          ...
          : _vm.currentPage === "group"
          ? _c("group", {
              on: { changePage: _vm.changePage, groupId: _vm.groupId }
            })
          ...
          ? _c("invite", { attrs: { groupId: _vm.idGroup } })
          : _vm.currentPage === "edit"
          ? _c("edit")
          : _c("createg", { on: { changePage: _vm.changePage } })
      ],
      1
    )
  ])
...
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","./App.vue":"src/App.vue","semantic-ui-vue":"node_modules/semantic-ui-vue/dist/commonjs/semantic-ui-vue.js","../assets/style/style.css":"assets/style/style.css","axios":"node_modules/axios/index.js"}],"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "41247" + '/');
