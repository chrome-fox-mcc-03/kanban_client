...
var _default = {
  ...
  methods: {
    ...
    onSignInSuccess: function onSignInSuccess(googleUser) {
      console.log("GOOGLE SIGNIN STEP 1"); // `googleUser` is the GoogleUser object that represents the just-signed-in user.
      ...
      _vm.isLogin === false
        ? _c("LandingPage", {
            on: {
              ...
              userLogin1: _vm.login,
              userSignup1: _vm.signup
            }
          })
        : _vm._e(),
      _vm._v(" "),
