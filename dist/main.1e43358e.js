...
},{}],"../../../../.nvm/versions/node/v13.11.0/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":"../../../../.nvm/versions/node/v13.11.0/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"node_modules/vue-hot-reload-api/dist/index.js":[function(require,module,exports) {
var Vue // late bind
var version
var map = Object.create(null)
            ...
            [
              _c("div", { staticClass: "modal-content" }, [
                ...
                _c("div", { staticClass: "modal-body" }, [
                  _c("form", { attrs: { id: "createTask-form" } }, [
                    _vm._v("\n            Title\n            "),
                    _c("br"),
                    _vm._v(" "),
                    _c("input", {
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.taskCreds.title,
                          expression: "taskCreds.title"
                        }
                      ],
                      ...
                      domProps: { value: _vm.taskCreds.title },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.$set(_vm.taskCreds, "title", $event.target.value)
                        }
                      }
                    }),
                    _vm._v(" "),
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.taskCreds.category,
                            expression: "taskCreds.category"
                          }
                        ],
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.taskCreds.due_date,
                          expression: "taskCreds.due_date"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "date", id: "create-task-due-date" },
                      domProps: { value: _vm.taskCreds.due_date },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                ...
                _c("div", { staticClass: "modal-footer" }, [
                  ...
                  _c(
                    "button",
                    {
                      ...
                      attrs: { type: "button", form: "createTask-form" },
                      on: {
                        click: function($event) {
...
},{"_css_loader":"../../../../.nvm/versions/node/v13.11.0/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/LandingPage.vue":[function(require,module,exports) {
"use strict";
      ...
      _c("form", { attrs: { id: "form-login" } }, [
        ...
        _c("div", { staticClass: "form-group" }, [
          ...
          _c("input", {
            ...
            domProps: { value: _vm.userCreds.email },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.userCreds, "email", $event.target.value)
              }
            }
          }),
          _vm._v(" "),
        ...
        _c("div", { staticClass: "form-group" }, [
          ...
          _c("input", {
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.userCreds.password,
                expression: "userCreds.password"
              }
            ],
            staticClass: "form-control",
            attrs: {
            ...
            domProps: { value: _vm.userCreds.password },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.userCreds, "password", $event.target.value)
              }
            }
          })
        ]),
              ...
              _c("div", { staticClass: "modal-content" }, [
                ...
                _c("div", { staticClass: "modal-footer" }, [
                  ...
                  _c(
                    ...
                    {
                      staticClass: "btn btn-primary",
                      attrs: { type: "button", form: "signup-form" },
                      on: {
                        click: function($event) {
                          $event.preventDefault()
...
},{"_css_loader":"../../../../.nvm/versions/node/v13.11.0/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/TaskCard.vue":[function(require,module,exports) {
"use strict";
    ...
    _c("div", { staticClass: "card" }, [
      _c("div", { staticClass: "card-body" }, [
        _c("h5", { staticClass: "card-title" }, [
          _vm._v(_vm._s(_vm.unitTask.id))
        ]),
        _vm._v(" "),
        _c("h5", { staticClass: "card-title" }, [
          _vm._v(_vm._s(_vm.unitTask.title))
        ]),
        _vm._v(" "),
        _c("h6", { staticClass: "card-subtitle mb-2 text-muted" }, [
          _vm._v(_vm._s(_vm.unitTask.due_date))
        ]),
        _vm._v(" "),
        _c(
          "button",
...
},{"_css_loader":"../../../../.nvm/versions/node/v13.11.0/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/TaskBox.vue":[function(require,module,exports) {
"use strict";
...
var _TaskBox = _interopRequireDefault(require("./TaskBox.vue"));
...
var _default = {
  ...
  methods: {
    ...
    getTaskDetails4: function getTaskDetails4(data) {
      this.taskId = data.id;
      this.title = data.title;
      this.category = data.category;
      var date = new Date(data.due_date);
      this.due_date = this.parseDate(date); // this.due_date = `${date.getFullYear()}-0${date.getMonth()}-0${date.getDate()}`;
    ...
    parseDate: function parseDate(inputted) {
      var yyyy = String(inputted.getFullYear());
      var mm = inputted.getMonth() + 1;
      var dd = inputted.getDate();
...
exports.default = _default;
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { attrs: { id: "pg-dashboard" } }, [
    _c("h3", { staticClass: "header" }, [_vm._v("MY TASKS")]),
    _vm._v(" "),
              ...
              _c(
                ...
                [
                  _c("div", { staticClass: "modal-content" }, [
                    ...
                    _vm._v(" "),
                    _c("div", { staticClass: "modal-body" }, [
                      _c("form", { attrs: { id: "editTask-form" } }, [
                        _c("label", { staticStyle: { color: "black" } }, [
                          _vm._v("Title")
                        ]),
                        _vm._v(" "),
                        _c("input", {
...
},{"./TaskBox.vue":"src/components/TaskBox.vue","_css_loader":"../../../../.nvm/versions/node/v13.11.0/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/App.vue":[function(require,module,exports) {
"use strict";
...
var _LandingPage = _interopRequireDefault(require("./components/LandingPage.vue"));
  ...
  methods: {
    ...
    signup: function signup(dataFromChild) {
      ...
      axios({
        ...
        console.log("RESPONSE IS");
        console.log(response); // this.$toasted.success(`Welcome to Kanban, ${email}`)
      }).catch(function (err) {
        // arr = JSON.parse(err.responseText).message
        console.log(err.response.data);
    ...
    fetchTasks: function fetchTasks() {
      ...
      axios({
        ...
        console.log(response);
        _this3.sortedTasks = response.data.data;
        _this3.tasks = response.allData;
      }).catch(function (err) {
        console.log(err);
    ...
    createTask: function createTask(dataFromChild) {
      var _this4 = this;
      ...
      axios({
        ...
        console.log(err.response); // console.log(error.response.data.errorMessage);
    ...
    editTask: function editTask(dataFromChild) {
      var _this5 = this;
      ...
      axios({
        method: 'put',
        url: "".concat(URL, "/tasks/").concat(dataFromChild.id),
        headers: {
          // token : localStorage.getItem('token')
          token: this.token
        },
        ...
        _this5.task = response.data;
        console.log(_this5.task);

        _this5.fetchTasks();
      }).catch(function (err) {
        console.log("EDIT FAILS"); // console.log(error.response.data.errorMessage);

        console.log(err.response.data); // this.$toasted.error(err.response.data.errorMessage, {
        //     position: 'bottom-center'
        // })
    ...
    deleteTask: function deleteTask(dataFromChild) {
      ...
      axios({
        method: 'delete',
        url: "".concat(URL, "/tasks/").concat(dataFromChild),
        headers: {
          // token : localStorage.getItem('token')
          token: this.token
        },
        ...
        console.log("DELETE FAILS"); // console.log(error.response.data.errorMessage);

        console.log(err.response.data);

        _this6.$toasted.error(err.response.data.message, {
          position: 'bottom-center'
        });
      });
    },
    logout: function logout(dataFromChild) {
      this.isLogin = false;
      localStorage.clear();
    }
  },
...
},{"./components/Navbar.vue":"src/components/Navbar.vue","./components/LandingPage.vue":"src/components/LandingPage.vue","./components/Dashboard.vue":"src/components/Dashboard.vue","_css_loader":"../../../../.nvm/versions/node/v13.11.0/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"node_modules/vue-toasted/dist/vue-toasted.min.js":[function(require,module,exports) {
var define;
...
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","./App.vue":"src/App.vue","axios":"node_modules/axios/index.js","vue-toasted":"node_modules/vue-toasted/dist/vue-toasted.min.js"}],"../../../../.nvm/versions/node/v13.11.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
