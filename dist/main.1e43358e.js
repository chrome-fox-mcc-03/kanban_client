          ...
          _c(
            ...
            [
              _c("div", { staticClass: "modal-content" }, [
                ...
                _vm._v(" "),
                _c("div", { staticClass: "modal-body" }, [
                  _c("form", { attrs: { id: "deleteTask-form" } }, [
                    _vm._v("\n            ID\n            "),
                    _c("br"),
                    _vm._v(" "),
                    _c("input", {
                      ...
                      domProps: { value: _vm.dropId },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.dropId = $event.target.value
                        }
                      }
                    })
                  ])
                ...
                _c("div", { staticClass: "modal-footer" }, [
                  ...
                  _c(
                    ...
                    {
                      staticClass: "btn btn-primary",
                      attrs: { type: "button", form: "deleteTask-form" },
                      on: {
                        click: function($event) {
                          $event.preventDefault()
  ...
  methods: {
    ...
    fetchTasks: function fetchTasks() {
      ...
      axios({
        ...
        console.log(response);
        _this2.sortedTasks = response.data.data;
        _this2.tasks = response.allData;
    ...
    editTask: function editTask(dataFromChild) {
      ...
      axios({
        method: 'put',
        url: "http://localhost:3000/tasks/".concat(dataFromChild.id),
        headers: {
          // token : localStorage.getItem('token')
          token: this.token
        },
    ...
    deleteTask: function deleteTask(dataFromChild) {
      ...
      axios({
        method: 'delete',
        url: "http://localhost:3000/tasks/".concat(dataFromChild),
        headers: {
          // token : localStorage.getItem('token')
          token: this.token
        },
...
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","./App.vue":"src/App.vue","axios":"node_modules/axios/index.js"}],"../../../../.nvm/versions/node/v13.11.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
